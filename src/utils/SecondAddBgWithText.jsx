function SecondAddBgWithText({ animation }) {
  return (
    ...
    >
      ...
      <img
        className={`absolute z-10 w-20 top-[117px]    transition-all delay-[100ms] duration-300 ease-in-out   ${
          animation ? " mr-0  -mt-9" : " -mr-[62rem] -mt-[40rem]"
        } `}
        src="/images/&.png"
        alt="&"
      ...
      <img
        className={`relative z-0 top-[52px]  transition-all delay-150 duration-300 ease-in-out w-80  -mt-6  ${
