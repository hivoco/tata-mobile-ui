    ...
    <Layout bg={"images/ss1.png"}>
      <div className="px-4 pt-5  flex flex-col gap-[6.5rem]">
        ...
        <div className="flex flex-col gap-28 items-center ">
          <button
            className={` ${animation ? "transition-all delay-150 duration-200 ease-out opacity-0":"opacity-100"} purple-btn shadow-[2.7px_4.05px_0px_0px_black] flex items-center justify-center gap-1  px-20 py-4 rounded-[9px]  font-bold leading-[19.36px]`} 
            onClick={() => {
