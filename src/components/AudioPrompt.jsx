  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 ">
        <button className="text-[#1D55FD] text-xs font-semibold leading-[15px] text-center  py-[14px] px-[45px] rounded-[6.4px] border border-solid border-[#1D55FD]">
          NO
        </button>
        <button className="purple-btn  text-xs font-semibold leading-[15px] text-center  py-[14px] px-[45px] rounded-[6.4px] shadow-[2.5px_3.9px_0px_0px_black]">
          YES
        </button>
      </div>
    </div>
